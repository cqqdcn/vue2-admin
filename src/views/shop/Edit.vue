...
<script>
  ...
  export default {
    ...
    created() {
      this.shopFenglei()
      this.getShopData(this.goodsId)
    },
    methods: {
      // 进入获取数据
      async getShopData(goodsId) {
        const { data: res } = await this.$http.get(`goods/${goodsId}`)
        console.log(res.data)
        this.tabForm.goods_name = res.data.goods_name
        this.tabForm.goods_price = res.data.goods_price
        this.tabForm.goods_number = res.data.goods_number
        this.tabForm.goods_weight = res.data.goods_weight
        this.tabForm.goods_weight = res.data.goods_weight
        this.tabForm.pics = res.data.pics
        this.tabForm.goods_introduce = res.data.goods_introduce
        this.tabForm.attrs = res.data.attrs
      },
      async shopFenglei() {
