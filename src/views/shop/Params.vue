<template>
  <div>
    <el-card>
      <el-alert class="alert" title="注意：只允许为第三级分类设置相关参数！" type="warning" :closable="false" show-icon>
      </el-alert>
      <el-row class="cat_opt">
        <el-col>
          <span>选择商品分类：</span>
          <el-cascader v-model="selectKeys" :options="cateList" :props="{ expandTrigger: 'hover',value:'cat_id',label:'cat_name', children:'children'}"
            @change="cateChanged" clearable style="width: 300px">
          </el-cascader>
        </el-col>
      </el-row>
      <!-- Tabs 标签页 -->
        ...
        <el-tab-pane label="动态参数" name="many">
          ...
          <el-table :data="manyTableData" border stripe>
            ...
            <el-table-column label="操作" v-slot="scope">
              <el-button @click="showEditDialog(scope.row.attr_id)" type="primary" icon="el-icon-edit" size="mini">编辑
              </el-button>
